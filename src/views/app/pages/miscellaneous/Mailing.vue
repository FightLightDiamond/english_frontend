                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td style="padding-bottom: 30px;">
                                                <a href="#">
                                                    <img style="max-width: 100%; object-fit: cover; border-radius: 3px; margin-bottom:5px;" src="https://dore-jquery.coloredstrategies.com/img/carousel-1.jpg" />
                                                </a>
                                        ...
                                        <tr>
                                            <td style="padding-bottom: 30px;">
                                                <a href="#">
                                                    <img style="max-width: 100%; object-fit: cover; border-radius: 3px; margin-bottom:5px;" src="https://dore-jquery.coloredstrategies.com/img/carousel-2.jpg" />
                                                </a>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#">
                                                    <img style="max-width: 100%; object-fit: cover; border-radius: 3px; margin-bottom:5px;" src="https://dore-jquery.coloredstrategies.com/img/carousel-3.jpg" />
                                                </a>
